...
public class StreamArrayList {
	public static void main(String[] args) {
		...
		personList.add(new Person("야비환", 25));
		personList.add(new Person("렁이환", 20));
		personList.add(new Person("썽이환", 35));
		personList.add(new Person("렁환", 30));
		personList.add(new Person("혹환", 45));
		personList.add(new Person("건환", 40));
		...
		personList.stream()
				  ...
				  .forEach( name -> System.out.println(name));	//매핑한 name forEach로 반복
				  ;
		System.out.println();
