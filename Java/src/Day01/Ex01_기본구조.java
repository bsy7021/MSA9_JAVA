...
// public class 클래스명
// * 클래스명 = 파일명 (이름이 같아야 함)
// * class 영역 바깥에는 코드 작성 불가능
public class Ex01_기본구조 {
	// * 하나의 실행문은 ;(세미클론)으로 끝나야 함
	// 변수
	// 자료형 변수명;
	// 자료형 변수명 = 값;
	...
	// main 메소드 : 프로그램의 시작점
	// * main 메소드는 하나의 프로그램에 하나의 메소드가 구성됨(여러개 X)
	// main : ctrl + space
	public static void main(String[] args) {
		// 객체 생성
		// * 클래스타입 객체명 = new 클래스명();
		Ex01_기본구조 객체1 = new Ex01_기본구조();
		// * 객체를 생성해야만, 내부의 변수와 메소드를 접근(사용)할 수 있음.
		// * (.) 접근 연산자로 객체의 변수와 메소드를 접근 및 호출할 수 있음.
		// * 객체.변수
		// * 객체.메소드()
