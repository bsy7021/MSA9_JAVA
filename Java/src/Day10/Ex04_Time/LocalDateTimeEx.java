...
public class LocalDateTimeEx {
	public static void main(String[] args) {
		...
		//	남은 시간을 반환하는 메소드
		//* ChronoUnit : 날짜/시간 단위를 나타내는 열거타입(enum)
		//				 날짜/시간 차이를 구하거나 조작할 때 사용
		...
		System.out.println("헌재 날짜/시간 : " + now);
		...
		LocalDateTime targetTime = now.plusYears(1)
									  ...
									  ;
										//빌더 패턴(메소드 체이닝)
		System.out.println("번경 날짜/시간 : " + targetTime);
	}
}
